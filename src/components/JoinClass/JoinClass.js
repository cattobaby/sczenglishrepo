        ...
        <div className="joinClass">
          <div className="joinClass__wrapper">
            ...
            >
              ...
              <div className="joinClass__topHead">Unirse a la clase</div>
            </div>
            <Button
          ...
          <div className="joinClass__form">
            <p className="joinClass__formText">
              Has inciado sesión como {loggedInUser?.email}
            </p>
          ...
          <div className="joinClass__form">
            ...
            <div
              ...
              className="joinClass__formText"
            >
              Pídele a tu docente el código de tu clase, e introdúcelo aquí.
            </div>
            <div className="joinClass__loginInfo">
              <TextField
                id="outlined-basic"
